...
class Issue_report extends MY_Controller {
	...
	public function index()
	{
		...
		$template['body'] = 'Issue_report/list';
		$template['script'] = 'Issue_report/script';
	...
	public function get(){
		...
		$data = $this->Issue_report_model->getbranchCrTable($param,$branch_id);
		$all_total =0;
