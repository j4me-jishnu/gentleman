...
class Mutual_branch_transfer_report extends MY_Controller {
	...
	public function __construct() {
       ...
       if(! $this->is_logged_in()){
		...
		$this->load->model('Mutual_branch_transfer_model');
    }
	public function index()
	{
		$template['branch'] = $this->Users_model->get_branch();
		$template['body'] = 'Mutual_branch_report/list';
		$template['script'] = 'Mutual_branch_report/script';
	...
	public function get(){
		...
		$data = $this->Mutual_branch_transfer_model->getbranchCrTable($param);
