...
class NewMaster extends MY_Controller {
	...
	{
		$purcahse_id = $this->params['purcahse_id'];
		$condition = [
			'purchase_status' => 0,
		];
		$this->result = $this->General_model->update('ntbl_purchase',$condition,'purcahse_id',$purcahse_id);
	}
...
public function updatePurchaseReturns()
{
	...
	{
		$purchase_idse = $this->params['purcahse_id'];
		$purchase_list = $this->General_model->get_row('ntbl_purchase','purcahse_id',$purchase_idse);
