...
$(function () {
  ...
  $table = $('#designation_table').DataTable( {
    ...
    "ajax": {
      "url": "<?php echo base_url();?>NewMaster/getDesignationList/",
      'dataSrc':"",
      "type": "POST",
      "data" : function (d) {
    ...
    "columns": [
      { "data": "desg_status", "orderable": true },
      { "data": "desg_name", "orderable": false },
      { "data": null, "defaultContent":""},
    ]
  } );
});
function confirmDelete(desg_id){
  var conf = confirm("Do you want to Delete Designation Details ?");
  if(conf){
    $.ajax({
      url:"<?php echo base_url();?>NewMaster/deleteDesignation",
