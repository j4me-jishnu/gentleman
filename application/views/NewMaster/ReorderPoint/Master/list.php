...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">ROP Master Details</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="box">
          ...
          <?php $u = $this->session->userdata('user_type');
           if($u == 'A'){ ?>
                  <a href="<?php echo base_url();?>NewMaster/addROPmasterList" class="btn btn-primary"><i class="fa fa-plus-square"></i>  Add ROP Master</a>
                <?php } ?>
				</div>
            </div>
            <!-- /.box-header -->
