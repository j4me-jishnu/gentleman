        ...
        <div class="box box-info">
          ...
          <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>Users/add">
            ...
            <div class="box-body">
              ...
              <div class="col-sm-3">
                <input type="hidden" data-pms-required="true" class="form-control" name="ur_id" placeholder="ID" readonly value="<?php if (isset($records->ur_id)){ echo $records->ur_id; }
                else {
                  // if (isset($userid->ur_id)){echo $userid->ur_id + 1; } else { echo "1";}
                  echo '1';
                }?>">
              </div>
