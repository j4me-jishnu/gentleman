<script>
  ...
  $table = $('#Branch_Opening_Stock').DataTable( {
    ...
    "ajax": {
      ...
      "url": "<?php echo base_url();?>NewBranch/getBranchOpeningStocks/",
    ...
    //   }
      ...
      $('td', row).eq(9).html('<center><a onclick="editrequestBtoBModal('+data['os_id']+')"><i class="fa fa-edit iconFontSize-medium" ></i></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['os_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
