      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>openigstock/add">
              <!-- radio -->
            ...
            <option value="0">Master Stock</option>
					  ...
					  <label for="size_name" class="col-sm-1 control-label">OpenigStock<span style="color:red">*</span></label>

					  <div class="col-sm-2">
						  <input type="text" data-pms-required="true"  data-pms-type="digitsOnly" class="form-control" name="item_stock" placeholder="OpenigStock" value="<?php if(isset($records->item_quantity)) echo $records->item_quantity ?>">
					  </div>
          </div>
            <label for="size_name" class="col-sm-1 control-label">Date<span style="color:red">*</span></label>
            <div class="col-sm-2">
              <input type="date" data-pms-required="true" id="date" class="form-control" name="date"  placeholder="Date" value="<?php echo date('d/m/Y'); ?>">
            </div>
					</div>
                </div>
              <!-- /.box-body -->
