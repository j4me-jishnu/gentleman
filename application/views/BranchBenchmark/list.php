    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-2">
          ...
          ?>
                  <a href="<?php echo base_url();?>SetBranchBenchmark/add" class="btn btn-primary"><i class="fa fa-plus-square"></i> Add New</a>
        ...
        <div class="col-md-4">
          ...
          <div class="input-group-btn">
            <button type="button" class="btn btn-primary nohover">User</button>
          </div><!-- /btn-group -->
