      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>SetBranchBenchmark/add">
              <!-- radio -->
              ...
              ?>
					  ...
					  <div class="col-sm-1">
						<input type="text" data-pms-required="true"  class="form-control" name="benchmark" required="required">
					  </div>
            <label for="size_name" class="col-sm-1 control-label">Initial Date <span style="color:red">*</span></label>

            <div class="col-sm-2">
            <input type="date"  required  class="form-control" name="idate" id="vendorne" required="required">
            </div>
            <label for="size_name" class="col-sm-1 control-label">Final Date <span style="color:red">*</span></label>

            <div class="col-sm-2">
            <input type="date"  required  class="form-control" name="fdate" required="required">
            </div>
					</div>
                </div>
              <!-- /.box-body -->
