...
<!-- /.box-header -->
<!-- form start -->
<form class="form-horizontal" method="POST" action="<?php echo base_url();?>Setrop/add">
<!-- radio -->
...
<?php
  ...
  echo '<option value="'.$item[0]->item_id.'" selected>'.$item[0]->item_name.'</option>';
}
?>
</select>
...
<div class="col-sm-3">
<select id="branchid"  name="branchid" data-pms-required="true" data-pms-type="alphanumericsOnly" class="form-control pull-right select2" >
<option value="">----Please Select----</option>
<?php
