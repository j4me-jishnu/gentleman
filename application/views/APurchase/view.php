        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
			  <address class="adrs">
				Branch :Thalayolaparambu<br>
				Address : <?php if(isset($branch[0]->branch_address)){ echo $branch[0]->branch_address;}?><br>
				Phone : <?php if(isset($branch[0]->branch_phone)){ echo $branch[0]->branch_phone;}?><br>
				Email : <?php if(isset($branch[0]->branch_email)){ echo $branch[0]->branch_email;}?><br>
				<br>
			  </address>
            </div>
            <!-- /.box-header -->
               ...
               <div class="form-group">
                   ...
                   <table class="table table-striped table-responsive">
                       ...
                       <tbody>
                            ...
                            <td><center><a href="<?php echo base_url(); ?>Apurchaserequest/purchase_edit/<?php echo $records->pr_id; ?>" ><i class="fa fa-edit iconFontSize-medium" ></i></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>Apurchaserequest/delete/<?php echo $records->pr_id ?>"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center></td>
                       </tbody>
                       <?php } ?>
                   </table>
                   </div>
